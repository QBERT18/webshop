...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
     ...
     */
    private static final String[] UNRESTRICTED_ACCESS = {"/products","/verificationSuccess","/registrationSuccess", "/login", "/registration", "/login/failed", "/registration/**", "/impressum", "/contact"};
